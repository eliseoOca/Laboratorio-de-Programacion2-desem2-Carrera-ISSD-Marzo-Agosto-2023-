...
if (!empty($_POST['BtnRegistrar'])) {    
    $Mensaje = validar_input();
    if(empty($Mensaje)){
        //$Mensaje2 = validar_insert();
        if(insertar_turno($Miconexion,$_POST['pacientes'], $_POST['sesiones'], $_POST['fecha'],$_SESSION['usuario_id'])){
            $Mensaje = 'Error al guandar el turno';
        }else{
            $Mensaje2 = 'Se han registrado los datos ingresados. <br />';
        }
    }
}
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="dropdown pc-h-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-right pc-h-dropdown">
                            ...
                            <a href="Location: cerrar_sesion.inc.php" class="dropdown-item">
